 ...
 * Body JSON: { imageBase64: "<base64>", mimeType: "image/jpeg" } o { dataUrl: "data:image/jpeg;base64,..." }
 * Para uso desde la app de escritorio (elige imagen local y la sube).
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (body.dataUrl && typeof body.dataUrl === 'string') {
      ...
      dataUrl = `data:${mime};base64,${body.imageBase64}`;
    } else {
      return res.status(400).json({ error: 'Body debe incluir dataUrl o imageBase64' });
    }
