"""
Script para probar sincronización de usuarios
"""
import sqlite3
import requests
import json
...
def query_turso(sql, params=None):
    ...
    try:
        response = requests.post(
            ...
            json={
                "statements": [sql] if not params else [{"q": sql, "params": params}]
            }
        )
...
print("\n" + "="*80)
print("Para ejecutar la sincronización, abre catalogo_manager.py y usa el menú Sincronización")
print("="*80)
